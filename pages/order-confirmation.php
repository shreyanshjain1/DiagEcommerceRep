...
<div class="page-head">
  <h1>Order Flow Disabled</h1>
  <p class="muted">This website currently works on an RFQ basis. Online order confirmation is not used in the live customer journey.</p>
</div>

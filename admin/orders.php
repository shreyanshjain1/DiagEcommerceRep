...
?>
<h1>Legacy Orders</h1>
<div class="muted" style="margin-bottom:12px">This table is kept for historical compatibility. The active customer-facing flow is RFQ-first and should be managed from the RFQ module.</div>
<div style="display:flex;gap:10px;flex-wrap:wrap;margin-bottom:14px">
  <a class="btn" href="<?php echo url('admin/rfqs.php'); ?>">Open RFQs</a>
  <a class="btn secondary" href="<?php echo url('admin/inquiries.php'); ?>">Open Inquiries</a>
</div>
<table class="table">
